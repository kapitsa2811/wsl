...
class TextDetectorTrainer:
    ...
    def __init__(self, corpus=None, fonts=None):
        ...
        self.textAroundTable = 0 # want text around table
    ...
    def genTextAndHeatMap(self,nm):
        ...
        lineSpacing = random.randint(5,15)  # how many pixels to leave between lines
...
tr.trainingLoop(10)  # 1000 shows no of Document Images to generate

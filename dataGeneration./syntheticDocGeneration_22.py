...
class TextDetectorTrainer:
    ...
    def handleNonTableInsertion(self,LineWordLoc,fontObj,lineBegining,oldTextWidth,textHeight,x,y,yLimit,lineSpacing):
        ...
        for i in LineWordLoc.keys():
            ...
            for wordNo, wordDict in enumerate(textLine):
                ...
                # print "\n\t\t key=", wordSampleKey[0]
                wordSizeValue = wordDict[wordSampleKey[0]]
                ...
                if 1:
                    ...
                    self.tempCanvasPainterCopy.text((x, y), wordSampleKey[0], font=fontObj, fill='white')  # fg
    ...
    def genTextAndHeatMap(self,nm):
        ...
        lineSpacing = random.randint(15,25)  # how many pixels to leave between lines
        ...
        '''
            one by one takes line and brakes into words then put it in image also keep emty space for table/ figure
        '''
        for i in LineWordLoc.keys():
            ...
            for wordNo, wordDict in enumerate(textLine):
                ...
                if not wordNo == junkIndx:
                    ...
                    if self.maskText==1:
                        ...
                        self.tempHeatMapPainterCopy.rectangle(heatRect, "green")
                    oldTextWidth = textWidth
                    self.tempCanvasPainter.text((x, y), wordSampleKey[0], font=fontObj, fill='white')  # fg
                    self.tempCanvasPainterCopy.text((x, y), wordSampleKey[0], font=fontObj, fill='white')  # fg
                    #print "\n\t\t word=",wordSampleKey[0],"\t location=",(x,y)
                    ...
                    replaceLength = len(wordSampleKey[0])
    ...
    '''
    def genNoEasyEdges1(self,inserImage):
        ...
        for indx,key in enumerate(insertKeys):
            ...
            if shape == 0:  # line
                ...
                try:
                    self.tempCanvas.paste(image,(x1,y1,x2,y2))
...
tr.trainingLoop(600)  # 1000 shows no of Document Images to generate
